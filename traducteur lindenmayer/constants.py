...
#This file contains the various reused postscript code to be added
#to the lidenmayer.eps file.
...
#this is the base example provided by the teacher
#we need to replace this with our interpreter that translates
#on the go json formatted L-systems
example_1 = """
